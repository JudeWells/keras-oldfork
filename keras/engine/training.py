...
class Model(Container):
    ...
    def fit(self, x=None,
        ...
        if test_data:
            ...
            if len(test_data) == 2:
                ...
                raise ValueError('When passing test_data, '
    ...
    def fit_generator(self, generator,
        ...
        # Arguments
            ...
            test_steps: Only relevant if `validation_data`
                is a generator. Total number of steps (batches of samples)
                to yield from `generator` before stopping.
        ...
        if test_gen and not test_steps:
            raise ValueError('When using a generator for test data, '
                             'you must specify a value for '
                             '`test_steps`.')
